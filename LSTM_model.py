...
cutoff_date = pd.Timestamp('2013-10-01') #'2014-05-01' 
...
model.add(Dense(1, activation = 'relu')) #final output layer, fully-connected layer with a single neuron as we are predicting a single value
